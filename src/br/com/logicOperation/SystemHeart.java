...
import br.com.models.Executive;
...
public class SystemHeart {
    ...
    final Executive executiveCode = new Executive();
        ...
        while (true) {
            try {
                ...
                Optional<StringBuilder> processing = switch (choiceTest) {
                    case 1 -> Optional.of(commonCode.noRepetition(Message.getMessages().get(2)));
                    case 2 -> Optional.of(vipCode.noRepetition(Message.getMessages().get(2)));
                    case 3 -> Optional.of(executiveCode.noRepetition(Message.getMessages().get(2)));
